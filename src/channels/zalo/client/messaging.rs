...
impl ZaloMessaging {
    ...
    pub async fn send_text(
        ...
        let body: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("Invalid send response: {e}"))?;
    ...
    pub async fn send_reaction(
        ...
        self.client
            ...
            .send()
            .await
            .map_err(|e| anyhow::anyhow!("Reaction failed: {e}"))?;
    ...
    pub async fn undo_message(&self, msg_id: &str, thread_id: &str, cookie: &str) -> Result<()> {
        ...
        self.client
            ...
            .send()
            .await
            .map_err(|e| anyhow::anyhow!("Undo message failed: {e}"))?;
...
fn generate_client_id() -> String {
    let id: u64 = rand::random::<u64>() % 9_999_999_999;
    format!("cli_{}", id)
}
