...
impl ZaloBotClient {
    ...
    pub async fn get_me(&self) -> Result<BotInfo> {
        ...
        let body: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("getMe parse error: {e}"))?;
    ...
    pub async fn send_message(&self, chat_id: &str, text: &str) -> Result<SendResult> {
        ...
        let resp: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("sendMessage parse error: {e}"))?;
    ...
    pub async fn send_photo(
        ...
        let resp: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("sendPhoto parse error: {e}"))?;
    ...
    pub async fn get_updates(&mut self, timeout: Option<u32>) -> Result<Vec<BotUpdate>> {
        ...
        let resp: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("getUpdates parse error: {e}"))?;
    ...
    pub async fn set_webhook(
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| anyhow::anyhow!("setWebhook failed: {e}"))?;

        let resp: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("setWebhook parse error: {e}"))?;
    ...
    pub async fn delete_webhook(&self) -> Result<()> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| anyhow::anyhow!("deleteWebhook failed: {e}"))?;

        let resp: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("deleteWebhook parse error: {e}"))?;
    ...
    pub async fn get_webhook_info(&self) -> Result<WebhookInfo> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| anyhow::anyhow!("getWebhookInfo failed: {e}"))?;

        let resp: serde_json::Value = response
            .json()
            .await
            .map_err(|e| anyhow::anyhow!("getWebhookInfo parse error: {e}"))?;
